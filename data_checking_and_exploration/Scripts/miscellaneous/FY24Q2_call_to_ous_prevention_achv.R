...
semi_annual <- c("OVC_SERV", "KP_PREV", "TB_PREV", "GEND_GBV")
...
lab_leg<-case_when(metadata$curr_qtr==1 ~  c("<15%","15-35%",">35%"),
                   ...
                   metadata$curr_qtr==4 ~ c("<75%","75-89%","90-110%","+110%"))
...
df_achv_viz %>% 
  ...
  facet_wrap(~ind_w_glob_vals, nrow=1, scales = "free_y") +
  labs(x = NULL, y = NULL,
