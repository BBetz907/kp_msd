...
##########################################as with many of these, you tend to add more indicators to the view. it appears you used the QA/QC outline as your guide but didn't consult the dashboard. Also, since we're checking the data, we really need to see values, even if they aren't aesthetically pleasing. It's confusing because you say "by KP" but then emphasize everything by indicator
