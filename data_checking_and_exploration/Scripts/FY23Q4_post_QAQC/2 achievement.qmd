...
ach_country <- check %>% filter(fy == 2023, funding_agency %in% usaid_cdc, country == "Philippines", disagg == "KP") %>%
...
ach_mech <- check %>% filter(fy == 2023, mech_code == "81671", country == "Haiti", disagg == "KP") %>%
