...
kp_site_data_summary <- kp_site_data |> 
                  group_by(fiscal_year, funding_agency, operatingunit, country, snu1, snu2, cop22_psnu, psnu, community, facility, sitetype, sitename,  prime_partner_name, mech_code, mech_type,  mech_name, indicator, standardizeddisaggregate, otherdisaggregate_sub,) |> 
