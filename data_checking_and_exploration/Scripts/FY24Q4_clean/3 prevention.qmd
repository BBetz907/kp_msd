...
#   scale_color_manual(values = c(PrEP_NEW = "#8980cb", PrEP_CT = "#808080")) + glitr::si_style_nolines() + labs(title = glue::glue("PEPFAR {countries[1]} {prep_trends$disagg} trends "))
# 
...
#   scale_color_manual(values = c(PrEP_NEW = "#8980cb", PrEP_CT = "#808080")) + glitr::si_style_nolines() + labs(title = glue::glue("PEPFAR {countries[2]} {prep_trends$disagg} trends "))
```
